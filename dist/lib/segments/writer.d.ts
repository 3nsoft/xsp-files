...
export declare class SegWriter extends SegInfoHolder implements SegmentsWriter {
     ...
     * @param arrFactory
     */
    constructor(key: Uint8Array, packedKey: Uint8Array, header: Uint8Array | undefined, segSizein256bs: number | undefined, randomBytes: (n: number) => Uint8Array, arrFactory: arrays.Factory);
